function my_layer(option,type,cbok,cbcancle){
   ...
   if(opt.tip){
    ...
    //类型为alert
    if (type == 'success') {
        $('.layer_wrap img',box).attr('src', './images/ic_tip4.png');
        $('.btn_qx',box).hide();

    }

    if (type == 'error') {
        $('.layer_wrap img',box).attr('src', './images/ic_tip3.png');
        $('.btn_qx',box).hide();
    }
    ...
    if (type == 'warn') {
        ...
        $('.layer_wrap img',box).attr('src', './images/ic_tip2.png');
        $('.btn_qx',box).hide();
    }
    ...
    if (type == 'confirm') {
        ...
        $('.layer_wrap img',box).attr('src', './images/ic_tip5.png');
    }
